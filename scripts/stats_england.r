...
atp_stats_plot <- ggplot() + 
  # background data
  geom_line(data = atp_stats_long_monthly, aes(x = month, y = cyber_score, group = ods, colour = ods), colour = alpha("grey75", 0.7)) + 
  # average line
  ...
  ggtitle(paste("Cyber exposure scores for endpoints - NHS Trusts - January 2020 to", current_month_print, sep = " "), subtitle = "Data supplied by the NHS Digital Data Security Centre") +
  # plot theme
  theme_base() +
  theme(
