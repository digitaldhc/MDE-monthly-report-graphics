...
atp_stats_plot <- ggplot() + 
  ...
  ggtitle(paste("Cyber exposure scores for servers - Dorset NHS orgs - ", first_month_print,"to", current_month_print, sep = " "), subtitle = "Data supplied by the NHS England Cyber Security Operations Centre") +
  # plot theme
  theme_base() +
  theme(
